...
export const projectListings: readonly ProjectListing[] = Object.freeze([
  ...
  { repository: 'j-256/agent-skills', artifact: PROJECT_ARTIFACT.BUNDLE, meta: { source: PROJECT_META_SOURCE.PUSHED } },
  { repository: 'j-256/stream-eval', artifact: PROJECT_ARTIFACT.RUNNABLE, meta: { source: PROJECT_META_SOURCE.PUSHED } },
