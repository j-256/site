...
export const initialProjectListings: readonly ProjectListing[] = Object.freeze([
  ...
  { repository: 'j-256/cloudflare-fleet', artifact: PROJECT_ARTIFACT.BUNDLE, meta: { source: PROJECT_META_SOURCE.RELEASE } },
  { repository: 'j-256/maintainer-hq', artifact: PROJECT_ARTIFACT.BUNDLE, meta: { source: PROJECT_META_SOURCE.PUSHED } },
  { repository: 'j-256/guildcontrol', artifact: PROJECT_ARTIFACT.RUNNABLE, meta: { source: PROJECT_META_SOURCE.RELEASE } },
  { repository: 'j-256/sh', artifact: PROJECT_ARTIFACT.RUNNABLE, meta: { source: PROJECT_META_SOURCE.PUSHED } },
]);

export const disclosedProjectListings: readonly ProjectListing[] = Object.freeze([
  ...
  { repository: 'j-256/querypatch', artifact: PROJECT_ARTIFACT.BUNDLE, meta: { source: PROJECT_META_SOURCE.PUSHED } },
  { repository: 'j-256/persistent-clicker', artifact: PROJECT_ARTIFACT.BUNDLE, meta: { source: PROJECT_META_SOURCE.RELEASE } },
  { repository: 'j-256/timestamp-only', artifact: PROJECT_ARTIFACT.BUNDLE, meta: { source: PROJECT_META_SOURCE.RELEASE } },
  { repository: 'j-256/rover-dumper', artifact: PROJECT_ARTIFACT.RUNNABLE, meta: { source: PROJECT_META_SOURCE.RELEASE } },
  { repository: 'j-256/binary-watch-face', artifact: PROJECT_ARTIFACT.BUNDLE, meta: { source: PROJECT_META_SOURCE.PUSHED } },
  { repository: 'j-256/plugin_rootfile', artifact: PROJECT_ARTIFACT.BUNDLE, meta: { source: PROJECT_META_SOURCE.PUSHED } },
  { repository: 'j-256/pwa-kit-extensibility', artifact: PROJECT_ARTIFACT.BUNDLE, meta: { source: PROJECT_META_SOURCE.PUSHED } },
  { repository: 'Strange-Lasers/strangelasers.com', artifact: PROJECT_ARTIFACT.BUNDLE, meta: { source: PROJECT_META_SOURCE.PUSHED } },
